...
type TestimonialHeader = {
  id: string;
  topBadgeText: string;
  topBadgeTextColor: string;
  topBadgeBgColor: string;
  h1TextPrefix: string;
  h1TextPrefixColor: string;
  h1TextMain: string;
  h1TextMainColor: string;
  sectionBgColor: string;
};

const AdminTestimonialHeaderEditor = () => {
  const [data, setData] = useState<TestimonialHeader | null>(null);
  ...
  const handleChange = (field: keyof TestimonialHeader, value: string) => {
    if (!data) return;
