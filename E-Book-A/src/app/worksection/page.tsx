...
const AdminWorkSectionEditor = () => {
  const [form, setForm] = useState<WorkSectionType | null>(null);
          ...
          <div key={field}>
            ...
            {field.toLowerCase().includes("colour") ? (
              <input
                type="color"
                name={field}
                value={form[field as keyof WorkSectionType] || "#000000"}
              ...
              <input
                type="text"
                name={field}
                value={(form[field as keyof WorkSectionType] as string) || ""}
                onChange={handleChange}
