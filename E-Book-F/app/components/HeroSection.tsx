...
const Hero = () => {
  ...
  return (
    <div className="relative w-full min-h-[60vh] overflow-hidden flex items-center justify-center">
      <video
      ...
      <div className="relative z-10 w-full h-full px-4 py-10 sm:px-8 md:px-12 flex flex-col md:flex-row justify-center items-center gap-8">
        {/* Left Content */}
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          ...
          <h3
            className="text-lg sm:text-xl lg:text-5xl font-medium"
          ...
          <button
            className="sm:text-lg  font-bold py-2 px-6 rounded-md w-fit"
            style={{
        ...
        {/* Right Form */}
        <div
          className="w-full md:w-[30%] p-5 rounded-lg shadow-lg mt-6 md:mt-0"
        ...
        >
          <div className="relative p-6 rounded-lg text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-sm">
              ...
              <button
                type="submit"
                className="w-full py-2 rounded text-[22px] transition font-semibold"
                style={{
